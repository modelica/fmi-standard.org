...
Aarhus University, ABB, Algoryx, Altair, Akkodis, AMEPERE, Ansys, Augsburg University, Beckhoff, Boeing, Danfoss, DLR, Dynamica, EKS INTEC, ETAS, FMIOPT, Fraunhofer IEM, IAV, ITK Engineering, iVH, JuliaComputing, LTX, MachineWare, Model Based Innovation, orthogonal, Rensselaer Polytechnic Institute, Renault, Saab Group, Virtual Vehicle Research, Wolfram MathCore AB, Technical University Eindhoven, TLK Thermo, tracetronic, TU Dresden, Vector, _and all Steering Committee Members_
