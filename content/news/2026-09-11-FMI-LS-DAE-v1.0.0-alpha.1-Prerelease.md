...
It also reports successful tests in the following tools: CasADi, Dymola, FMIOPT, Simcenter Twin Activate, and MOO (the dynamic optimization tool of OpenModelica).
